const data = [
    ...
    {   id: 5,
        name: `LiChess Data Tracker`,
        description: `An ongoing personal project to help users of Lichess.org view different stats over time. The site calls the lichess external API, and organizes the data in a way that the end user can interpret comfortably. This project highlights skills in CRUD API usage, and UX design.`,
        // img: pizza,
        link:  `https://github.com/Caleb-Campbell/lichess-data-tracker`,
        skills: ['HTML', 'CSS', 'React', 'React-Router'],
        open: false
